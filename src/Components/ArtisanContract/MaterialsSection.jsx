...
const MaterialsSection = ({
  ...
  const isClientProcurement = procurementResponsibility === "client";
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        >
          <option value="">Select procurement responsibility</option>
        ...
        <p className="text-sm leading-5 text-[#A65E18]">
          {isClientProcurement ? (
            <>
              ...
              Materials lists are preserved below for sizing reference, but
              costs are mapped as ₦0.00 since client executes purchasing
              independently.
            </>
          ) : (
            <>
              <span className="font-bold">Important Security Note:</span>{" "}
              Material funds computed below will be routed directly from the
              client to your profile. The platform's escrow wallet exclusively
              holds labour fees.
            </>
          )}
        </p>
      ...
      <div>
        ...
        <div className="space-y-2">
          {materials.map((material, index) => {
            ...
            const displayedTotal = isClientProcurement ? 0 : total;
              ...
              >
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateMaterial(index, "unitPrice", e.target.value)
                    }
                    className="w-full h-10 rounded-md border border-gray-300 px-2 text-sm outline-none focus:ring-2 focus:ring-black"
                  />
                </div>
