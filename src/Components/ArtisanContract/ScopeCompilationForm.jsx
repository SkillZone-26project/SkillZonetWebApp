      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          >
            ...
            <input id="verification" type="file" className="hidden" />
          </label>
        </div>
        ...
        <div className="rounded-lg border border-gray-300 p-4">
          ...
          <div className=" mt-5 w-full max-w-[572px] min-h-[72px] rounded-[8px] px-3 sm:px-4 py-[14px] bg-[#F5F5F5] shadow-[0_0_12px_0_#0000001A] flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
            ...
            <button
              type="button"
              className="flex-1 h-11 px-2 py-3 rounded-lg border border-[#111827] flex items-center justify-center gap-2 text-sm font-semibold text-[#111827] hover:bg-gray-50 transition">
              <CreditCard
                size={18}
                strokeWidth={2}
            ...
            <button
              ...
              className="flex-1 h-11 px-2 py-3 rounded-lg border border-[#E5A23A] flex items-center justify-center gap-2 text-sm font-semibold text-[#D18400] hover:bg-[#FFF8EC] transition">
              <Clock3 size={18} strokeWidth={2} className="text-[#D18400]" />
