        ...
        <div className="flex items-center gap-3">
          <div>
            ...
            <p className="text-sm text-[#797786] mt-4">
              Review the terms compiled on-site by the artisan. You can approve
              the variation order to release work execution or return it back
              for pricing adjustment.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="rounded-lg border border-gray-300 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-[#111827]">Payment Option</h3>
          </div>

          <div className="rounded-lg bg-white shadow-[0_2px_10px_rgba(0,0,0,0.12)] p-3">
            <p className="font-semibold text-[#111827]">Full Payment</p>
        ...
        <div>
          <h3 className="font-semibold text-[#070616]">On-site Work Preview</h3>
        ...
        <div className="bg-[#FFFBEB] p-4 rounded-sm">
          <div className="flex gap-3">
            <TriangleAlert size={28} className="text-[#FFCD0F]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          ...
          <button className="h-11 rounded-md bg-[#16A34A] text-white font-semibold hover:bg-green-700 transition text-sm">
            <div className="flex items-center justify-center gap-2">
              <Check size={20} />
              Approve & Release
            </div>
